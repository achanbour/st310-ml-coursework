...
```{r}
#autoplot(model_ridge, xvar = "lambda")
...
```{r}
beta_new_D <- beta + rnorm(p, sd=0.1) #adding noise to the beta parameters when predicting test data, equivalent to change the distribution of the test data
